...
def train_me(test_name, env_name, start_level, num_levels, game_mode, param_name, num_timesteps, seed, log_level, print_stage, num_checkpoints, background):
...
if __name__=='__main__':
    ...
    train_me(test_name, env_name, start_level, num_levels, game_mode, param_name, num_timesteps, seed, log_level, print_stage, num_checkpoints, background);
